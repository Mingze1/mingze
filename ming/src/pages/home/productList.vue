<template>
 <div class="recommend" >
    ...
    <ul class="recommend-list">
      <li class="recommend-item" v-for="(item,key) in productList" :key="key" @click="findProduct(key)">
        <router-link :to="{name:'home-product',params:{id:item.baseinfo.itemId,img:item.baseinfo.picUrl}}" class="recommend-link">
                ...
                .then(res => {
                    // console.log(res.data);
                       ...
                       let obj = {
                        ...
                        this.$emit('loaded',obj)  //派发事件loaded
                    }
                })
                .catch( err => {
                    console.log(err);
